 ...
 * Stable Release - Expanded Code
 */

// Fallback de Segurança para Config
if (typeof CONFIG === 'undefined') {
    console.warn("CONFIG.js não carregado. Usando padrões.");
...
function zeniteSystem() {
    return {
        ...
        // Getters Seguros
        get archetypes() { 
            return (typeof RPG !== 'undefined') ? RPG.archetypes : []; 
        },
        ...
        async initSystem() {
            ...
            // Failsafe: Destrava tela em 8s se der erro
            setTimeout(() => { 
        ...
        setupListeners() {
            ...
            // SFX Listener Global (Anti-spam via Element Tracking)
        ...
        async fetchCloud() {
            ...
            } catch(e) { console.warn("Cloud fetch warn", e); }
        },
        ...
        processImport(e) { 
            ...
            r.onload = (evt) => { 
                ...
                } catch(e){ this.notify('Erro arquivo.', 'error'); } 
            }; 
            r.readAsText(f); 
        },
        ...
        // --- MOUSE ENGINE (Corrigida e Forçada) ---
        setupCursorEngine() {
            const trail = document.getElementById('mouse-trail');
            // Check Mobile
            ...
            const renderLoop = () => {
                ...
                // AQUI É O PULO DO GATO: Checa se tem usuário OU se é guest
                const isAuthenticated = this.user || this.isGuest;
